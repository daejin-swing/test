...
# ported verbatim from openpilot's common/i2c.py -- a plain Linux i2c-dev
# SMBus ioctl wrapper, stdlib only (os/fcntl/ctypes), no external package
# needed (unlike location/gpsd.py's pyserial/crcmod).
